...
//         <h1 className='Whysell9:text-[42px] md:text-[38px] Whysell12:text-[32px] Whysell14:text-[28px] text-[25px] md:w-full Whysell11:w-[700px] Whysell12:w-[500px] Whysell13:w-[350px] Whysell14:w-[300px] w-[250px] font-semibold text-center mt-[82px]'>Why are you looking to sell your Property?</h1>
...
//             Items.map((item,key) => {
//              return (
//                 <div className='flex items-center justify-start space-x-2 md:ml-0 Whysell11:ml-16 Whysell12:ml-12 Whysell13:ml-9 Whysell14:ml-7 ml-5'>
...
//       </h1>
//       <div className='text-center grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-x-12 Whysell11:mt-[80px] Whysell14:mt-[65px] mt-[45px]'>
//         {/* This block is only for grid-cols-1 to maintain the order */}
//         {itemsInOrder.map((item, key) => (
//           <div key={key} className='flex items-center justify-start space-x-2 md:ml-0 Whysell11:ml-16 Whysell12:ml-12 Whysell13:ml-9 Whysell14:ml-7 ml-5 xl:hidden md:hidden'>
//             <span className="text-[#45C22E] text-[22px]">✓</span>
//             <h2 className='Whysell13:text-[22px] Whysell14:text-[19px] text-[17px] font-light'>{item.item1}</h2>
//           </div>
//         ))}
        
//         {/* This block is for grid-cols-2 and grid-cols-4 */}
//         {Items.map((item, key) => (
//           <div key={key} className=' items-center justify-start space-x-2 md:ml-0 Whysell11:ml-16 Whysell12:ml-12 Whysell13:ml-9 Whysell14:ml-7 ml-5 xl:flex md:flex hidden'>
//             <span className="text-[#45C22E] text-[22px]">✓</span>
//             <h2 className='Whysell13:text-[22px] Whysell14:text-[19px] text-[17px] font-light'>{item.item1}</h2>
//           </div>
//         ))}
    ...
    <div className='roboto'>
      ...
      <div className='text-center grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-x-12 Whysell11:mt-[80px] Whysell14:mt-[65px] mt-[45px]'>
        ...
        {itemsInOrder.map((item, key) => (
          <div
            key={key}
            className={`flex items-center justify-start space-x-2 md:ml-0 Whysell11:ml-16 Whysell12:ml-12 Whysell13:ml-9 Whysell14:ml-7 ml-5 xl:hidden md:hidden ${
              (key + 1) % 8 === 0 ? 'mb-8' : ''
            }`}
          >
            <span className="text-[#45C22E] text-[22px]">✓</span>
