...
const ReviewTextEffect = () => {
  return (
    <div className=''>
         <div className="relative h-[50vh] bg-fixed bg-cover bg-center " style={{ backgroundImage: 'url("https://optim.tildacdn.net/tild6636-3730-4333-b063-383833333431/-/format/webp/shutterstock_2181685.jpg")' }}>
...
export default ReviewTextEffect